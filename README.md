...
# ● 📞 call — тез фарёд кардан мекунад  // Аргументҳо алоҳида-алоҳида дода мешаванд.
# <img src="./img/Снимок экрана 2026-05-31 044526.png">
# ● 📋 apply — мисли call, аммо массив   //  Аргументҳо дар массив дода мешаванд.
# <img src="./img/Снимок экрана 2026-05-31 044835.png">
# ● 🔗 bind — функсияи нав месозад  //  Функсияи нав месозад, tez иҷро намекунад — баъдтар даъват мекунӣ.
# <img src="./img/Снимок экрана 2026-05-31 045159.png">
# ✓ ⚖️ Фарқашон як ҷо
# • Фавран  иҷро мешавад? ⇨✅ ⇨ ✅ ⇨ ❌  ⇨⇨⇨⇨  call
# • Аргументҳо  ⇨ алоҳида  ⇨ массив  ⇨ алоҳида   ⇨⇨⇨⇨  apply
# • Чӣ бармегардонад ⇨ натиҷа  ⇨ натиҷа  ⇨ функсияи нав  ⇨⇨⇨⇨   bind
# <img src="./img/Снимок экрана 2026-05-31 045735.png">